module.exports = {
  ...
  '复制链接': 'Copy Link',
  '更换链接': 'Change Link',
  '请选择订阅链接类型：': 'Pleses select subscribe type',
  '将域名转换为IP地址': 'Convert domain name to IP address',
  '显示流量信息': 'Show traffic information',
  '账号二维码': 'Account QR code',
  'IOS快速导入订阅': 'IOS QuickImport Subscribe',
  'Clash快速导入订阅': 'Clash QuickImport Subscribe',
  '不限时': 'unlimited',
  '不限量': 'unlimited',
  '无': 'none',
  '或': 'or',
